package com.db.dprice.kisapp.concurrency;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.threadAndHandlerButton).setOnClickListener(this);
    ...
    public void onClick(final View v) {
        ...
        switch (v.getId()) {
            case R.id.anrButton:
                ...
                break;
            case R.id.threadAndHandlerButton:
                intent = ThreadAndHandlerActivity.getIntent(this);
                break;
